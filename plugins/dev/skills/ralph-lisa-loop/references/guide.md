...
| An ordinary plan/build/review request starts the loop | Broad semantic triggers inferred consent for heavyweight orchestration | Keep frontmatter explicit-only and apply the `SKILL.md` activation gate before preflight |
